 ...
 * @version 0.1
 * 
 * This trait simplifies the specification of AND-combinations of individual 
 * conditions as part of the Conditions component of nAdico statements.
 * 
 */
trait ConditionExpression {
  
  def AND(condition: ConditionExpression): ConditionCombination = {
    ConditionCombination(this, Combinator.AND, condition)
  }
